...
2. **Bases de Datos**:
   - **Oracle Database 23c Free (Clientes)**: Instancia dedicada con PDB `FREEPDB1` en host `oracle-clients-db:1522`
   - **Oracle Database 23c Free (Facturas)**: Instancia dedicada con PDB `FREEPDB1` en host `oracle-invoices-db:1523`
...
| `ORACLE_DATABASE` | Clients, Invoices | `FREEPDB1` | Nombre de BD (cada instancia tiene su propio FREEPDB1) |
